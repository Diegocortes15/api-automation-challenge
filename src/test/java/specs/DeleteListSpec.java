...
public class DeleteListSpec {
    ...
    public void deleteListTest() {
        LoggerLoad.info("Test: Should delete a movie list");
        ...
        assertThat(responseGetListDetails.jsonPath().get("status_message"), containsString(ErrorConstants.DETAILS_LIST_STATUS_MESSAGE_ERROR));
    }
}
